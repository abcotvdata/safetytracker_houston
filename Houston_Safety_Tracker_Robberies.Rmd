...
Across the city the last 12 months, there were about <h8>`r round(robberies_city$last12mos/52,1)`</h8> robberies every week. In 2019, that number was <h8>`r round(robberies_city$total19/52,1)`</h8> per week
