...
<br>
About three years ago, the robbery rate in Houston was <h8>`r robberies_city$rate19`</h8> per 100,000 residents - or just slightly less than the rate of deaths in motor vehicle crashes in Texas (12.5).

During the pandemic years, the risk of homicide in Houston rose above the risk of being killed in a traffic crash. The average robbery rate for the three-year period from 2019 to 2022 was <h8>`r robberies_city$rate_prior3years`</h8> and last year it was <h8>`r robberies_city$rate21`</h8>.
...
In fact, <h8>`r round(pop_robberieszero/2304580*100,0)`%</h8> of people live in neighborhoods where there were no homicides at all over the last 12 months.
...
Across the city the last 12 months, there were about <h8>`r round(robberies_city$last12mos/52,1)`</h8> homicides every week. In 2019, that number was <h8>`r round(robberies_city$total19/52,1)`</h8> per week
