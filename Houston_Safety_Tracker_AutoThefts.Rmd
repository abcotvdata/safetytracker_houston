...
<br>
Across Houston over the last 12 months, there were about <h8>`r round(autothefts_city$last12mos/52,0)`</h8> vehicles stolen every week. In 2019, <h8>`r round(autothefts_city$total19/52,0)`</h8> vehicles were were being stolen per week.

About three years ago, the auto theft rate in Houston was <h8>`r round(autothefts_city$rate19,0)`</h8> per 100,000 residents. However, during the pandemic years, the risk of auto theft in Houston rose sharply.

The average auto theft rate for the three-year period from 2019 to 2022 was <h8>`r round(autothefts_city$rate_prior3years,0)`</h8> and last year it was <h8>`r round(autothefts_city$rate21,0)`</h8>.
...
The map color-codes each neighborhood by the motor vehicle theft rate over the last 12 months, through the end of March, which is the most recent comprehensive data released by the Houston Police Department.
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            ...
            labels=c("Lowest Rate", 
                     ...
                     "Highest Rate"),
            position = "topleft", 
            title = "<popuptitle>Houston Neighborhood Auto Thefts Map</popuptitle><br><popupchatter>Explore auto thefts per 100,000 people in your neighborhood</popupchatter><br>") 
