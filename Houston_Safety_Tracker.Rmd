...
<h2>ABC 13 is tracking murders, and other crimes, across the city and in your neighborhood. Here's a look at what's happening with rising killings in the city. You can also examine other crimes by choosing here: <select onchange="window.location=this.value">
<option></option>
