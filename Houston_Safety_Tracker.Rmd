...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            ...
            labels=c("Lowest Rate", 
                     ...
                     "Highest Rate"),
            position = "topleft", 
            title = "<popuptitle>Houston Neighborhood Homicide Map</popuptitle><br><popupchatter>Explore homicides Per 100,000 people in your neighborhood. Use the bar above to find a place, address or landmark.</popupchatter><br>") 
