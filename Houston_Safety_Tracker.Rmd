...
<br>
The murder rate in Houston is up from <h8>`r murders_city$rate_prior3years`</h8> per 100,000 residents over the three-year average from 2019 to 2022 and up from the <h8>`r murders_city$rate19`</h8> in 2019 before the pandemic changed many people's lifestyles and movements throughout most of 2020 and 2021.

However, that's not the case in the majority of neighborhoods. About <h8>`r murders_city$rate19`%</h8> of Houston's residents live in neighborhoods where the murder rate over the last 12 months is down or flat compared to the three-year average. Only <h8>`r murders_city$rate19`%</h8> of Houston residents live in neighborhoods where the murder rate is up more than 20%.

About <h8>`r murders_city$rate19`%</h8> of Houston's residents live in neighborhoods where there were zero murders over the last 12 months and </h8>`r murders_city$rate19`%</h8> of people live in neighborhoods where there were zero or one murder in the three-plus years from 2019 through last month.

To provide some context about the frequency of murders, there were <h8>`r murders_city$rate19`</h8> per week citywide in 2019 compared to <h8>`r murders_city$rate19`</h8> per week over the last 12 months, through `r max(houston_crime$date)`.

<subhead>Houston homicides neighborhood by neighborhood</subhead>

ABC13 looked at the data, beat by beat across the city and is providing this look at the murder trends by neighborhood for each of the last four years in the map below. The color-coding of the map is based on the murder rate over 2019, 2020 and 2021 combined, according to ABC13's analysis of data the Houston Police Department publishes monthly.
