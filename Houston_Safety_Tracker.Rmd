...
<br>
Across Houston, over the last 12 months, there were about <h8>`r round(murders_city$last12mos/52,1)`</h8> homicides every week. In 2019, that number was <h8>`r round(murders_city$total19/52,1)`</h8> per week.

To put the danger in context, the homicide rate in Houston was <h8>`r murders_city$rate19`</h8> per 100,000 residents three years ago in 2019. That was slightly less than the rate of people being killed in vehicle crashes in Texas, which is roughly 12.5 per 100,000 people.

During the pandemic years, the risk of being killed by another person rose well above the likelihood of being killed in a vehicle crash.

The average annual murder rate for the three-year period from 2019 to 2022 was <h8>`r murders_city$rate_prior3years`</h8>. Last year, it jumped to <h8>`r murders_city$rate21`</h8>.
...
The risk, of course, is not the same neighborhood to neighborhood across the city.

About <h8>`r round(pop_murdersup/2304580*100,0)`%</h8> of Houston residents live in neighborhoods where the murder rate is up more than 20% over the last 12 months compared to the three-year average from 2019 to 2021. About <h8>`r round(pop_murdersdown/2304580*100,0)`%</h8> of residents live in areas where the murder rate is falling or about the same. 
...
The map color-codes each neighborhood by the homicide rate over the last 12 months, through the end of March, which is the most recent comprehensive data released by the Houston Police Department.

The yellow areas are neighborhoods where the homicide rate is among the 25% highest rates in the city. You can click on any neighborhood to see detailed figures, rates and trends.
...
```
<br>
About <h8>`r round(pop_murdersmonthly/2304580*100,0)`%</h8> of us now live in neighborhoods where there was at least one murder every month over the last year. Here's a look at citywide homicides per month since 2019.
<br>
