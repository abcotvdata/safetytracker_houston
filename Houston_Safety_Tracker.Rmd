...
<h2>ABC 13 is tracking murders, and other crimes, across the city and in your neighborhood. Here's a look at what's happening with rising killings in the city. You can also examine other crimes by choosing here: <select>
...
<bignumber>`r round((murders_city$last12mos/2304580)*100000,1)`<br></bignumber><p>
...
"</td>
				...
				multi rows -->
				<td rowspan='5'>",
ifelse(murders_beat$inc_prior3yearavgtolast12>=0,"Last 12<br>months is up","Last 12<br>months is down"),
"<br><chartbignumber>",
