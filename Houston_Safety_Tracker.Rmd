...
# author: "John Kelly"
date: "Updated 3/21/2022 by the ABC13 Data Team"
...
<h2>ABC 13 is tracking murders, and all other crimes, across the city and in your neighborhood. Here's a look at what's happening with rising killings in the city.</h2>

So far this year<br>
<h3>`r prettyNum(sum(murders_by_beat$total22), big.mark=",")`<br></h3>
people have been murdered.<br>
<br>
We are on track to reach<br>
<h3>`r prettyNum(sum(murders_by_beat$projected22), big.mark=",")`<br></h3>
killings in 2022.<br>
<br>
That's more than the<br>
<h3>`r prettyNum(sum(murders_by_beat$total21), big.mark=",")`<br></h3>
murders in 2021.<br>
<br>
If so, the murder rate would be <br>
<h3>`r round(sum(murders_by_beat$projected22)/2304580*100000,1)`<br></h3>
per 100,000 residents.<br>
<br>
The rate 3 years ago was <br>
<h3>`r murders_citywide$rate19`<br></h3>
per 100,000 residents.<br>
<br>
<br>
...
"</td>
				...
				multi rows -->
				<td rowspan='4'>2022<br>projection is",
...
In the first two months of the year, <h7>`r prettyNum(sum(murders_by_beat$total22), big.mark=",")`</h7> people have been murdered across Houston.

The city is on track to experience <h7>`r prettyNum(sum(murders_by_beat$projected22), big.mark=",")`</h7> killings in 2022.

That's more than the total of <h7>`r prettyNum(sum(murders_by_beat$total21), big.mark=",")`</h7> murders in 2021.

If the pace of killings continues throughout 2022, that would be a murder rate of about <h7>`r round(sum(murders_by_beat$projected22)/2304580*100000,1)`</h7> murders per 100,000 residents in the city. The rate just three years ago was <h7>`r murders_citywide$rate19`</h7>.
