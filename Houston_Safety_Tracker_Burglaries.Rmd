...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            ...
            labels=c("Lowest Rate", 
                     ...
                     "Highest Rate"),
            position = "topleft", 
            title = "<popuptitle>Houston Neighborhood Burglaries Map</popuptitle><br><popupchatter>Explore sexual burglaries per 100,000 people in your neighborhood. Use the bar above to find a place, address or landmark.</popupchatter><br>") 
