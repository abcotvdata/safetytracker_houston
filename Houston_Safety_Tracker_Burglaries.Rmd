...
<br>
Over the last 12 months, there were about <h8>`r round(burglaries_city$last12mos/52,0)`</h8> burglaries every week in Houston. In 2019, that number was <h8>`r round(burglaries_city$total19/52,0)`</h8> per week.

The average burglary rate for the three-year period from 2019 to 2022 was <h8>`r round(burglaries_city$rate_prior3years,0)`</h8> per 100,000 residents. Last year, the rate was <h8>`r round(burglaries_city$rate21,0)`</h8>.
...
The map color-codes each neighborhood by the burglary rate over the last 12 months, through the end of March, which is the most recent comprehensive data released by the Houston Police Department.

The yellow areas are neighborhoods where the burglary rate is among the 25% highest rates in the city. You can click on any neighborhood to see detailed figures, rates and trends.
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            ...
            labels=c("Lowest Rate", 
                     ...
                     "Highest Rate"),
            position = "topleft", 
            title = "<popuptitle>Houston Neighborhood Burglaries Map</popuptitle><br><popupchatter>Explore sexual burglaries per 100,000 people in your neighborhood</popupchatter><br>") 
...
<iframe title="Risk of burglary in Houston vs. risk of other crimes and dangers" aria-label="Dot Plot" id="datawrapper-chart-HVqY5" src="https://datawrapper.dwcdn.net/HVqY5/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="196" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
