...
<br>
About three years ago, the burglary rate in Houston was <h8>`r round(burglaries_city$rate19,0)`</h8> per 100,000 residents - or just slightly less than the rate of deaths in motor vehicle crashes in Texas (12.5).

During the pandemic years, the risk of burglary in Houston rose above the risk of being killed in a traffic crash. The average burglary rate for the three-year period from 2019 to 2022 was <h8>`r round(burglaries_city$rate_prior3years,0)`</h8> and last year it was <h8>`r round(burglaries_city$rate21,0)`</h8>.
...
About <h8>`r round(pop_burglariesup/2304580*100,0)`%</h8> of Houston residents live in neighborhoods where the burglary rate is up more than 20% in the last 12 months when compared to the three-year average from 2019 to 2021.
...
Across the city the last 12 months, there were about <h8>`r round(burglaries_city$last12mos/52,0)`</h8> burglaries every week. In 2019, that number was <h8>`r round(burglaries_city$total19/52,0)`</h8> per week
