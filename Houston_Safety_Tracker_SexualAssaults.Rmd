...
About <h8>`r round(pop_sexassaultsdown/2304580*100,0)`%</h8> of city residents live in neighborhoods where the sexassault rate over the last 12 months is down or about the same as the three-year average.

Only <h8>`r round(pop_sexassaultszero/2304580*100,0)`%</h8> of people live in neighborhoods where there were no sexual assaults at all over the last 12 months.
...
Across the city the last 12 months, there were about <h8>`r round(sexassaults_city$last12mos/52,1)`</h8> homicides every week. In 2019, that number was <h8>`r round(sexassaults_city$total19/52,1)`</h8> per week
