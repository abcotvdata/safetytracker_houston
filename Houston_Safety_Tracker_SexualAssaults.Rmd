...
<br>
Across Houston over the last 12 months, there were about <h8>`r round(sexassaults_city$last12mos/52,0)`</h8> sexual assaults every week. In 2019, that number was <h8>`r round(sexassaults_city$total19/52,0)`</h8> per week.

About three years ago, the sexual assault rate in Houston was <h8>`r sexassaults_city$rate19`</h8> per 100,000 residents. The average sexual assault rate from 2019 to 2022 was <h8>`r sexassaults_city$rate_prior3years`</h8>. Last year, it was <h8>`r sexassaults_city$rate21`</h8>.
