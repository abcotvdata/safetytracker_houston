...
<br>
Homicides are <h8>`r ifelse(sexassaults_city$inc_prior3yearavgtolast12>=0," up"," down")` `r ifelse(sexassaults_city$inc_prior3yearavgtolast12>=0,sexassaults_beat$inc_prior3yearavgtolast12,substring(sexassaults_city$inc_prior3yearavgtolast12,2))`%</h8> over the last 12 months compared to the average from 2019-2021.

The city averaged <h8>`r round(sexassaults_city$last12mos/52,0)`</h8> homicides a week since last April. In 2019, that number was <h8>`r round(sexassaults_city$total19/52,0)`</h8> a week.
