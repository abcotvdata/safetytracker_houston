...
<br>
About three years ago, the assault rate in Houston was <h8>`r prettyNum(round(assaults_city$rate19,0), big.mark=",")`</h8> per 100,000 residents.

The average assault rate for the three-year period from 2019 to 2022 was <h8>`r prettyNum(round(assaults_city$rate_prior3years,0), big.mark=",")`</h8> and last year it was <h8>`r prettyNum(round(assaults_city$rate21,0), big.mark=",")`</h8>.
...
In fact, <h8>`r round(pop_assaultszero/2304580*100,0)`%</h8> of people live in neighborhoods where there were no assaults at all over the last 12 months.
