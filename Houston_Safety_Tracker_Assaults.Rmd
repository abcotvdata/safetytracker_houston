...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            ...
            labels=c("Lowest Rate", 
                     ...
                     "Highest Rate"),
            position = "topleft", 
            title = "<popuptitle>Houston Neighborhood Assaults Map</popuptitle><br><popupchatter>Explore assaults per 100,000 people in your neighborhood.<br>Use the bar above to find a place, address or landmark.</popupchatter><br>") 
houston_assault_map
```
<br>
