...
<br>
Across Houston over the last 12 months, there were about <h8>`r prettyNum(round(assaults_city$last12mos/52,0), big.mark=",")`</h8> assaults every week. In 2019, that number was <h8>`r prettyNum(round(assaults_city$total19/52,0), big.mark=",")`</h8> per week.

About three years ago, the assault rate in Houston was <h8>`r prettyNum(round(assaults_city$rate19,0), big.mark=",")`</h8> per 100,000 residents. The average assault rate from 2019 to 2022 was <h8>`r prettyNum(round(assaults_city$rate_prior3years,0), big.mark=",")`</h8>. Last year, it was <h8>`r prettyNum(round(assaults_city$rate21,0), big.mark=",")`</h8>.
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            ...
            labels=c("Lowest Rate", 
                     ...
                     "Highest Rate"),
            position = "topleft", 
            title = "<popuptitle>Houston Neighborhood Assaults Map</popuptitle><br><popupchatter>Explore assaults per 100,000 people in your neighborhood</popupchatter><br>") 
houston_assault_map
```
<br>
