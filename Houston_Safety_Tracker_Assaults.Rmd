...
<bignumber>`r prettyNum(assaults_city$total22, big.mark=",")`<br></bignumber><p>
...
<br>
About three years ago, the assault rate in Houston was <h8>`r assaults_city$rate19`</h8> per 100,000 residents - or just slightly less than the rate of deaths in motor vehicle crashes in Texas (12.5).

During the pandemic years, the risk of homicide in Houston rose above the risk of being killed in a traffic crash. The average assault rate for the three-year period from 2019 to 2022 was <h8>`r assaults_city$rate_prior3years`</h8> and last year it was <h8>`r assaults_city$rate21`</h8>.
...
Across the city the last 12 months, there were about <h8>`r round(assaults_city$last12mos/52,1)`</h8> homicides every week. In 2019, that number was <h8>`r round(assaults_city$total19/52,1)`</h8> per week
