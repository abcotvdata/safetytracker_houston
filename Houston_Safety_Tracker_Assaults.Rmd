...
The city averaged <h8>`r round(assaults_city$last12mos/52,0)`</h8> assaults a week since last May. In 2019, that number was <h8>`r round(assaults_city$total19/52,0)`</h8> a week.
