...
<bignumber>`r prettyNum(round(assaults_city$total22,0), big.mark=",")`<br></bignumber><p>
people have been assaulted.</p>
</div>
<div class="card" style="background-color:#99a0a5;">
...
<div class="card" style="background-color:#99a0a5;">
<p>The assault rate is <br>
<bignumber>`r round(assaults_city$rate_last12,0)`<br></bignumber><p>
per 100K people the last year.</p>
</div>
</div>
<br>
About three years ago, the assault rate in Houston was <h8>`r prettyNum(round(assaults_city$rate19,0), big.mark=",")`</h8> per 100,000 residents - or just slightly less than the rate of deaths in motor vehicle crashes in Texas (12.5).

During the pandemic years, the risk of homicide in Houston rose above the risk of being killed in a traffic crash. The average assault rate for the three-year period from 2019 to 2022 was <h8>`r prettyNum(round(assaults_city$rate_prior3years,0), big.mark=",")`</h8> and last year it was <h8>`r prettyNum(round(assaults_city$rate21,0), big.mark=",")`</h8>.

The situation, of course, is not the same neighborhood to neighborhood.

About <h8>`r round(pop_assaultsdown/2304580*100,0)`%</h8> of city residents live in neighborhoods where the assault rate over the last 12 months is down or about the same as the three-year average. 

In fact, <h8>`r round(pop_assaultszero/2304580*100,0)`%</h8> of people live in neighborhoods where there were no homicides at all over the last 12 months.

But, about <h8>`r round(pop_assaultsup/2304580*100,0)`%</h8> of Houston residents live in neighborhoods where the assault rate is up more than 20% in the last 12 months when compared to the three-year average from 2019 to 2021.

And, <h8>`r round(pop_assaultsmonthly/2304580*100,0)`%</h8> of us now live in neighborhoods where there was at least one assault every month over the last year.

Across the city the last 12 months, there were about <h8>`r prettyNum(round(assaults_city$last12mos/52,0), big.mark=",")`</h8> homicides every week. In 2019, that number was <h8>`r prettyNum(round(assaults_city$total19/52,0), big.mark=",")`</h8> per week

<subhead>Houston homicides neighborhood by neighborhood</subhead>

ABC13 looked at the Houston Police Department's data, beat by beat across the city and is providing this look at the assault trends by neighborhood for each of the last four years in the map below. The color-coding of the map is based on the assault rate over 2019, 2020 and 2021 combined, according to ABC13's analysis of data the city police department publishes monthly.
...
However, in the vast majority of neighborhoods in the city, the rate is much lower. In 17 of 118 of the Houston Police Department's, the assault rate was zero last year. Filler, filler, filler.
<br>
<br>
