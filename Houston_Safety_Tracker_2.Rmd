...
<h3>`r prettyNum(sum(murders_by_beat$projected22), big.mark=",")`<br></h3><p>
killings in 2022.</p>
</div>
<div class="card" style="background-color:#99a0a5;">
...
<tr>
<td>
<center>So far this year<br>
<h3><center>`r prettyNum(sum(murders_by_beat$total22), big.mark=",")`<br></h3>
people have been murdered.<br>
</td>
<td>
<center>We are on track to reach<br>
<h3><center>`r prettyNum(sum(murders_by_beat$projected22), big.mark=",")`<br></h3>
killings in 2022.<br>
</td>
<td>
<center>That's more than the<br>
<h3><center>`r prettyNum(sum(murders_by_beat$total21), big.mark=",")`<br></h3>
murders in 2021.<br>
</td>
</tr>
<tr>
<td><center>At current pace, the murder rate will be <br>
<h3><center>`r round(sum(murders_by_beat$projected22)/2304580*100000,1)`<br></h3>
per 100,000 residents in 2022.<br>
</td>
<td>
<center>The rate last year was <br>
<h3><center>`r murders_citywide$rate21`<br></h3>
per 100,000 residents.<br>
</td>
<td>
<center>The rate just 3 years ago was <br>
<h3><center>`r murders_citywide$rate19`<br></h3>
per 100,000 residents.<br>
</td>
</tr>
</table>
...
Here's a quick look at a datawrapper embed


<iframe title="Houston Neighborhood Crime Test Table" aria-label="Table" id="datawrapper-chart-T23TE" src="https://datawrapper.dwcdn.net/T23TE/4/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="732" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
  
One with the presearch filled in.

<iframe title="Houston Neighborhood Crime Test Table" aria-label="Table" id="datawrapper-chart-T23TE" src="https://datawrapper.dwcdn.net/T23TE/4/?search=Burglary" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="732" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
