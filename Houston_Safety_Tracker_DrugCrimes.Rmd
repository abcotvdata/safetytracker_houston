...
<bignumber>`r drugs_city$rate_last12`<br></bignumber><p>
per 100K people the last year.</p>
</div>
</div>
<br>
About three years ago, the drug crime rate in Houston was <h8>`r drugs_city$rate19`</h8> per 100,000 residents.

The average drug crime rate for the three-year period from 2019 to 2022 was <h8>`r drugs_city$rate_prior3years`</h8> and last year it was <h8>`r drugs_city$rate21`</h8>.
...
Across the city the last 12 months, there were about <h8>`r round(drugs_city$last12mos/52,1)`</h8> drug crimes every week. In 2019, that number was <h8>`r round(drugs_city$total19/52,1)`</h8> per week
