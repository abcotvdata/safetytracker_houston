...
<bignumber>`r thefts_city$rate_last12`<br></bignumber><p>
per 100K people the last year.</p>
</div>
</div>
<br>
About three years ago, the theft rate in Houston was <h8>`r thefts_city$rate19`</h8> per 100,000 residents - or just slightly less than the rate of deaths in motor vehicle crashes in Texas (12.5).

During the pandemic years, the risk of homicide in Houston rose above the risk of being killed in a traffic crash. The average theft rate for the three-year period from 2019 to 2022 was <h8>`r thefts_city$rate_prior3years`</h8> and last year it was <h8>`r thefts_city$rate21`</h8>.
...
Across the city the last 12 months, there were about <h8>`r round(thefts_city$last12mos/52,1)`</h8> homicides every week. In 2019, that number was <h8>`r round(thefts_city$total19/52,1)`</h8> per week
