...
<br>
About three years ago, the theft rate in Houston was <h8>`r round(thefts_city$rate19,0)`</h8> per 100,000 residents - or just slightly less than the rate of deaths in motor vehicle crashes in Texas (12.5).

During the pandemic years, the risk of homicide in Houston rose above the risk of being killed in a traffic crash. The average theft rate for the three-year period from 2019 to 2022 was <h8>`r round(thefts_city$rate_prior3years,0)`</h8> and last year it was <h8>`r round(thefts_city$rate21,0)`</h8>.
...
And, <h8>`r round(pop_theftsmonthly/2304580*100,0)`%</h8> of us now live in neighborhoods where there was at least one theft every month over the last year.

Across the city the last 12 months, there were about <h8>`r round(thefts_city$last12mos/52,0)`</h8> homicides every week. In 2019, that number was <h8>`r round(thefts_city$total19/52,0)`</h8> per week
