...
The danger is not the same neighborhood to neighborhood. ABC13's data team looked at the Houston Police Department's public data about sexual assault reports by neighborhood from 2020 through `r format(asofdate, "%B %d")`.
...
"</td>
				...
				<td>",
sexassaults_beat$avg_prior4years,
"</td>
				<td>",
sexassaults_beat$rate_prior4years,
"</td>
			</tr>
</table>")
