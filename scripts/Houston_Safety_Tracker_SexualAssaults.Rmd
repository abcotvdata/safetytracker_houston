...
The city averaged <h8>`r round(sexassaults_city$last12mos/52,0)`</h8> sexual assaults a week since last July. In 2019, that number was <h8>`r round(sexassaults_city$total19/52,0)`</h8> a week.
...
The map color-codes each neighborhood by the sexual assault rate over the last 12 months, through the end of July, which is the most recent comprehensive data released by the Houston Police Department.

The red areas are neighborhoods where the rate is among the 20% highest rates in the city.
...
sexassaultpal <- colorQuantile(c("#667f99",
                             ...
                             "#0058f6",
                             "#ffba00",
                       "#be0000"), sexassaults_beat$rate_last12, n = 5, na.color = NA)
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addPolygons(color = "white", 
              ...
              opacity = 0.6, 
              fillOpacity = 0.5,
              fillColor = ~sexassaultpal(rate_last12)) %>% 
