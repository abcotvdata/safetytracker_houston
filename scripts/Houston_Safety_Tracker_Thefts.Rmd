...
"</td>
				<td>",
prettyNum(round(thefts_beat$rate22,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>2023</td>
...
"</td>
				<td>",
prettyNum(round(thefts_beat$rate23,0), big.mark=","),
"</td>
			</tr>
						<tr>
...
"</td>
				...
				<td>",
round(thefts_beat$avg_prior4years,0),
"</td>
				<td>",
prettyNum(round(thefts_beat$rate_prior4years,0), big.mark=","),
"</td>
			</tr>
</table>")
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addPolygons(color = "white", 
    ...
    addPolygons(color = "white", 
              ...
              group="Number") %>% 
  addSearchOSM(options = searchOptions(collapsed=FALSE, minLength = 3,
...
<br>
<br>
<!-- <subhead>Thefts month by month, 2020 to present</subhead> -->
...
<iframe title="Thefts month by month, 2020 through last month" aria-label="Column Chart" id="datawrapper-chart-J86iw" src="https://datawrapper.dwcdn.net/J86iw/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
  ...
  <br>
<br>
<iframe title="2021 property crime rate comparison in select major cities" aria-label="Bar Chart" id="datawrapper-chart-T4Oq6" src="https://datawrapper.dwcdn.net/T4Oq6/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="580" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
