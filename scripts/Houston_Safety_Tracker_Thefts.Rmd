...
The city averaged <h8>`r prettyNum(round(thefts_city$last12mos/52,0), big.mark=",")`</h8> thefts a week since last July. In 2019, that number was <h8>`r prettyNum(round(thefts_city$total19/52,0), big.mark=",")`</h8> a week.
...
The map color-codes each neighborhood by the theft rate over the last 12 months, through the end of July, which is the most recent comprehensive data released by the Houston Police Department.
...
theftpal <- colorQuantile(c("#667f99",
                             ...
                             "#0058f6",
                             "#ffba00",
                       "#be0000"), thefts_beat$rate_last12, n = 5, na.color = NA)
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addPolygons(color = "white", 
              ...
              opacity = 0.6, 
              fillOpacity = 0.5,
              fillColor = ~theftpal(rate_last12)) %>% 
