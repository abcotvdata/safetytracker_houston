...
The map color-codes each neighborhood by the burglary rate over the last 12 months, through the end of July, which is the most recent comprehensive data released by the Houston Police Department.

The red areas are neighborhoods where the burglary rate is among the 20% highest rates in the city.
