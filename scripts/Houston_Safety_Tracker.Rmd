...
The city averaged <h8>`r round(murders_city$last12mos/52,0)`</h8> homicides a week since last August. In 2019, that number was <h8>`r round(murders_city$total19/52,0)`</h8> a week.
