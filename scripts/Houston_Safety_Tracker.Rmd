...
div {
  background-color: rgba(255, 255, 255, 0.99)   /* 99% opaque white */;
  padding: 0.25em;
}
...
The map color-codes each neighborhood by the homicide rate over the last 12 months. The red areas are neighborhoods where the homicide rate is among the 20% highest in the city.
