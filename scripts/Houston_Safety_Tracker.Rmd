...
<br>
Homicides over the last 12 months are trending <h8>`r ifelse(murders_city$inc_22tolast12>=0," up"," down")` `r ifelse(murders_city$inc_23tolast12>=0,murders_city$inc_23tolast12,substring(murders_city$inc_23tolast12,2))`%</h8> compared to 2022, according to the latest data available from the Houston Police Department.

However, the murder rate over the last 12 months is<h8>`r ifelse(murders_city$inc_prior4yearavgtolast12>=0," up"," down")` `r ifelse(murders_city$inc_prior4yearavgtolast12>=0,murders_city$inc_prior4yearavgtolast12,substring(murders_city$inc_prior4yearavgtolast12,2))`%</h8> compared to the annual average over the last four years.

The city averaged <h8>`r round(murders_city$last12mos/52,0)`</h8> homicides a week over the last 12 months. In 2020, that number was <h8>`r round(murders_city$total20/52,0)`</h8> a week.

One way to think about the danger: four years ago, the murder rate was <h8>`r murders_city$rate20`</h8> per 100,000 residents. That's slightly less than the risk of dying in a vehicle crash in Texas.
...
ABC13's data team looked at the Houston Police Department's data by neighborhood from 2020 through `r format(asofdate, "%B %d")`.
...
"</td>
				...
				<td>",
murders_beat$avg_prior4years,
"</td>
				<td>",
murders_beat$rate_prior4years,
"</td>
			</tr>
</table>")
...
<iframe title="What time of day do murders happen?" aria-label="Donut Chart" id="datawrapper-chart-coxAA" src="https://datawrapper.dwcdn.net/coxAA/12/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="432" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
<!-- <subhead>Major cities comparison</subhead> -->

<iframe title="2021 homicide rate comparison in select major cities" aria-label="Bar Chart" id="datawrapper-chart-rPkQ5" src="https://datawrapper.dwcdn.net/rPkQ5/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="412" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
