---
title: "<br>NEIGHBORHOOD<br>SAFETY TRACKER<br><br>"
# author: "John Kelly"
...
.title {
  background-image: url('https://abcotvdata.github.io/safetytracker_houston/skyline2.png');
...
<br>
Homicides over the last 12 months are <h8>`r ifelse(murders_city$inc_prior3yearavgtolast12>=0," up"," down")` `r ifelse(murders_city$inc_prior3yearavgtolast12>=0,murders_city$inc_prior3yearavgtolast12,substring(murders_city$inc_prior3yearavgtolast12,2))`%</h8>  compared to the annual average over the last three years.

Killings are trending <h8>`r ifelse(murders_city$inc_21tolast12>=0," up"," down")` `r ifelse(murders_city$inc_21tolast12>=0,murders_city$inc_21tolast12,substring(murders_city$inc_21tolast12,2))`%</h8> over the most recent 12 months compared to 2021.
...
One way to think about the danger: three years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. That's about the same as your chance of dying in a vehicle crash in Texas.
...
About <h8>`r round(pop_murdersup/houston_population*100,0)`%</h8> of people live in neighborhoods where the murder rate is higher than the likelihood of being killed in a traffic crash in Harris County.

ABC13's data team looked at the Houston Police Department's data by neighborhood from 2019 through `r format((Sys.Date() - 2), "%B %d")`.
