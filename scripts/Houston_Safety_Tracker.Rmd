---
title: "<br><br>NEIGHBORHOOD<br>SAFETY TRACKER"
# author: "John Kelly"
...
.title {
  background-image: url('https://abcotvdata.github.io/safetytracker_houston/skyline2.jpg');
...
<br>
Homicides are <h8>`r ifelse(murders_city$inc_prior3yearavgtolast12>=0," up"," down")` `r ifelse(murders_city$inc_prior3yearavgtolast12>=0,murders_city$inc_prior3yearavgtolast12,substring(murders_city$inc_prior3yearavgtolast12,2))`%</h8> over the last 12 months compared to the average from 2019-2021, and they are trending <h8>`r ifelse(murders_city$inc_21tolast12>=0," up"," down")` `r ifelse(murders_city$inc_21tolast12>=0,murders_city$inc_21tolast12,substring(murders_city$inc_21tolast12,2))`%</h8> over the most recent 12 months compared to all of 2021.

The city averaged <h8>`r round(murders_city$last12mos/52,0)`</h8> homicides a week since last July. In 2019, that number was <h8>`r round(murders_city$total19/52,0)`</h8> a week.
...
<iframe title="" aria-label="Dot Plot" id="datawrapper-chart-9SHHa" src="https://datawrapper.dwcdn.net/9SHHa/14/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="146" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
...
The map color-codes each neighborhood by the homicide rate over the last 12 months. The darker blue areas are neighborhoods with murder rates higher than the citywide rate.
...
murderpal2 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), murders_beat$rate_last12, bins = murderbins,na.color = "#51585f")

murderpal3 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addPolygons(color = "white", 
              ...
              opacity = 0.6, 
              fillOpacity = 0.6,
              fillColor = ~murderpal2(rate_last12),
              group="Rate") %>% 
    addPolygons(color = "white", 
              popup = murderlabel,
              popupOptions = popupOptions(maxWidth ="200", 
              ...
              opacity = 0.6, 
              fillOpacity = 0.6,
              fillColor = ~murderpal3(last12mos),
              group="Number") %>% 
  ...
  addLegend(opacity = 0.6,
            ...
            pal = murderpal3,
            position = "bottomleft", 
            title = paste(sep="","<popuptitle>Murders<br><popupchatter>Total murders people<br>Citywide: ",murders_city$last12mos),
            group = "Number",
