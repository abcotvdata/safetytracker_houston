...
About <h8>`r round(pop_murdersup/2304580*100,0)`%</h8> of people live in neighborhoods where the murder rate is higher than the likelihood of being killed in a traffic crash in Harris County.
...
The map color-codes each neighborhood by the homicide rate over the last 12 months. You can also choose to see neighborhoods by the number of homicides. The darker blue areas are neighborhoods with murder rates higher than the citywide rate.
