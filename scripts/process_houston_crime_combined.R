...
murders_beat <- beat_detailed %>% filter(nibrs_class=="09A") %>% filter(!is.na(district)& !is.na(placename)) 
sexassaults_beat <- beat_category %>% filter(category_name=="Sexual Assault")  %>% filter(!is.na(district)& !is.na(placename)) 
autothefts_beat <- beat_category %>% filter(category_name=="Auto Theft") %>% filter(!is.na(district)& !is.na(placename)) 
thefts_beat <- beat_category %>% filter(category_name=="Theft") %>% filter(!is.na(district)& !is.na(placename)) 
