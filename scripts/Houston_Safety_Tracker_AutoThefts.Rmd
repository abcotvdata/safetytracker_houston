...
The city averaged <h8>`r round(autothefts_city$last12mos/52,0)`</h8> stolen vehicles a week since last July. In 2019, that number was <h8>`r round(autothefts_city$total19/52,0)`</h8> a week.
...
The map color-codes each neighborhood by the motor vehicle theft rate over the last 12 months, through the end of July, which is the most recent comprehensive data released by the Houston Police Department.
