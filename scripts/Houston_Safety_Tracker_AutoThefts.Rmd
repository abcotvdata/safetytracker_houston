...
The city averaged <h8>`r round(autothefts_city$last12mos/52,0)`</h8> stolen vehicles a week since last June. In 2019, that number was <h8>`r round(autothefts_city$total19/52,0)`</h8> a week.
...
The map color-codes each neighborhood by the motor vehicle theft rate over the last 12 months, through the end of June, which is the most recent comprehensive data released by the Houston Police Department.
...
autotheftpal <- colorQuantile(c("#667f99",
                             ...
                             "#0058f6",
                             "#ffba00",
                       "#be0000"), autothefts_beat$rate_last12, n = 5, na.color = NA)
...
"</td>
				<td>",
round(autothefts_beat$rate19,0),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
"</td>
				<td>",
round(autothefts_beat$rate20,0),
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
round(autothefts_beat$rate21,0),
"</td>
			</tr>
						<tr>
...
"</td>
				<td>",
round(autothefts_beat$rate_last12,0),
"</td>
			</tr>
						<tr>
...
"</td>
				<td>",
round(autothefts_beat$rate_prior3years,0),
"</td>
			</tr>
</table>")
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addPolygons(color = "white", 
              ...
              opacity = 0.6, 
              fillOpacity = 0.5,
              fillColor = ~autotheftpal(rate_last12)) %>% 
  ...
  addLegend(opacity = 0.6,
            ...
            labels=c("Lowest Rate", 
                     ...
                     "Highest Rate"),
            position = "bottomleft", 
            title = "<popuptitle>Auto thefts<br>per 100,000 people")  
