...
The danger is not the same neighborhood to neighborhood. ABC13's data team looked at the Houston Police Department's data by neighborhood from 2019 through `r format((Sys.Date() - 2), "%B %d")`.
