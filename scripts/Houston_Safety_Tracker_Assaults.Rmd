...
<br>
Assaults over the last 12 months are <h8>`r ifelse(assaults_city$inc_prior4yearavgtolast12>=0," up"," down")` `r ifelse(assaults_city$inc_prior4yearavgtolast12>=0,assaults_city$inc_prior4yearavgtolast12,substring(assaults_city$inc_prior4yearavgtolast12,2))`%</h8> compared to the annual average over the last four years, according to the latest data available from the Houston Police Department.

The city averaged <h8>`r prettyNum(round(assaults_city$last12mos/52,0), big.mark=",")`</h8> assaults a week over the last 12 months. In 2020, that number was <h8>`r prettyNum(round(assaults_city$total20/52,0), big.mark=",")`</h8> a week.

<subhead>A closer look at Houston assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC13's data team looked at the Houston Police Department's data by neighborhood from 2020 through `r format(asofdate, "%B %d")`.
...
"</td>
				<td>",
prettyNum(round(assaults_beat$rate22,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>2023</td>
...
"</td>
				<td>",
prettyNum(round(assaults_beat$rate23,0), big.mark=","),
"</td>
			</tr>
						<tr>
...
"</td>
				...
				<td>",
round(assaults_beat$avg_prior4years,0),
"</td>
				<td>",
prettyNum(round(assaults_beat$rate_prior4years,0), big.mark=","),
"</td>
			</tr>
</table>")
