...
The city averaged <h8>`r prettyNum(round(assaults_city$last12mos/52,0), big.mark=",")`</h8> assaults a week since last June. In 2019, that number was <h8>`r prettyNum(round(assaults_city$total19/52,0), big.mark=",")`</h8> a week.
...
The map color-codes each neighborhood by the assault rate over the last 12 months, through the end of June, which is the most recent comprehensive data released by the Houston Police Department.
