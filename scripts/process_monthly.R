...
### IMPORT AND FORMAT 2023 and 2024 DATA TO DATE FROM HOUSTON PD EXCEL UPDATED MONTHLY HERE
...
houston24 <- read_excel("data/source/annual/houston_NIBRS2024.xlsx", 
                        col_types = c("text", "date", "numeric", 
                                      "text" , "text", "numeric", "text", 
                                      "text", "text", "text", "text", "text", 
                                      "text", "text","numeric","numeric"))
names(houston24) <- c("incident", "date", "hour", 
...
saveRDS(houston24,"scripts/rds/houston_monthly.rds")

# Clean up
rm(houston24,webpage,a_tags,links)
