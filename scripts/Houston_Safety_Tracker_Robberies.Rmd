...
<p>Last 12 months<br>Through  `r format((Sys.Date() - 2), "%B %d")`</p>
</div>
<div class="card" style="background-color:#99a0a5;">
...
The risk is not the same neighborhood to neighborhood. ABC13's data team looked at the Houston Police Department's data by neighborhood from 2019 through `r format((Sys.Date() - 2), "%B %d")`.
